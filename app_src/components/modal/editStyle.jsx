...
import { FiCopy, FiMinus, FiX } from 'react-icons/fi'
import { GiHorizontalFlip, GiVerticalFlip } from 'react-icons/gi'
import { GrBlockQuote, GrMonospace, GrSubscript, GrSuperscript } from 'react-icons/gr'
import { MdCancel, MdDelete, MdFormatColorText, MdSave } from 'react-icons/md'
...
const EditStyleModal = React.memo(function EditStyleModal() {
	...
	const [prefixColor, setPrefixColor] = React.useState(
		currentData.prefixColor || config.defaultPrefixColor
	)
	...
	const copyLayerStyle = () => {
		getActiveLayerText((data) => {
			if (!data.textProps.layerText?.textStyleRange.length) {
				return
			}

			if (!data.textProps.layerText?.paragraphStyleRange.length) {
				return
			}
			...
			firstParStyle.paragraphStyle.burasagari =
				firstParStyle.paragraphStyle.burasagari || 'burasagariNone'
			firstParStyle.paragraphStyle.singleWordJustification =
				firstParStyle.paragraphStyle.singleWordJustification || 'justifyAll'
			firstParStyle.paragraphStyle.justificationMethodType =
				firstParStyle.paragraphStyle.justificationMethodType || 'justifMethodAutomatic'
			firstParStyle.paragraphStyle.textEveryLineComposer =
				!!firstParStyle.paragraphStyle.textEveryLineComposer
				...
				<form className='app-modal-body-inner' onSubmit={saveStyle}>
					<div className='fields'>
						...
						<div className='field hostBrdTopContrast'>
							...
							<button
								type='button'
								className='style-edit-copy-btn topcoat-button--large'
						...
						<div className='field hostBrdTopContrast'>
							...
							<div className='field-input'>
								<div className='style-edit-color'>
									...
									<div
										className='style-edit-color-sample m-opacity'
										title={locale.editStyleColorButton}
										onClick={() => setColorPickerOpen(true)}
									>
										<div style={{ background: prefixColor }} />
									...
									<div className='style-edit-color m-right'>
										{strokePickerOpen && (
											<React.Fragment>
												<div
													className='color-picker-overlay'
													onClick={() => setStrokePickerOpen(false)}
												/>
												<SketchPicker
													disableAlpha={true}
										...
										<div
											className='style-edit-color-sample'
											title={locale.editStyleColorButton}
											onClick={() => setStrokePickerOpen(true)}
										>
											<div style={{ background: rgbToHex(stroke.color) }} />
...
const StyleDetails = React.memo(function StyleDetails(props) {
	...
	const currentFont = fonts.find(
		(font) => font.postScriptName === textStyle.fontPostScriptName
	) || {
	...
	const families = fonts.reduce(
		(fams, font) => (fams.includes(font.family) ? fams : fams.concat(font.family)),
		[]
	)
	...
	return (
		<div className='style-edit-props'>
			<div className='style-edit-props-row'>
				...
				<select
					value={textStyle.fontStyleName}
					onChange={(e) => changeFontStyle(e.target.value)}
					className='topcoat-textarea style-edit-font-style'
				>
					{currentFont.notFound && (
			...
			<div className='style-edit-props-row'>
				<div className='style-edit-props-col'>
					...
					<input
						...
						onChange={(e) => changeProp('size', Number.parseFloat(e.target.value) || null)}
						className='topcoat-text-input--large'
					/>
				...
				<div className='style-edit-props-col'>
					...
					<input
						...
						onChange={(e) => changeLeading(Number.parseFloat(e.target.value))}
						className='topcoat-text-input--large'
					/>
					<span className='style-edit-props-unit'>{unit}</span>
				</div>
			...
			{!textStyle.leading && (
				<div className='style-edit-props-row m-autoleading'>
					...
					<input
						...
						placeholder='120'
						value={
							paragStyle.autoLeadingPercentage
								? Number.parseInt(paragStyle.autoLeadingPercentage * 100, 10)
								: 120
						}
						onChange={(e) => changeAutoleading(Number(e.target.value))}
						className='topcoat-text-input--large'
					/>
			...
			<div className='style-edit-props-row'>
				<div className='style-edit-props-col'>
					...
					<select
						value={textStyle.autoKern || 'metricsKern'}
						onChange={(e) => changeProp('autoKern', e.target.value)}
						className='topcoat-textarea'
					>
				...
				<div className='style-edit-props-col'>
					...
					<input
						type='number'
						value={textStyle.tracking || 0}
						onChange={(e) => changeProp('tracking', Number(e.target.value) || 0)}
						className='topcoat-text-input--large'
					/>
				</div>
			</div>
			<div className='style-edit-props-row'>
				<div className='style-edit-props-col'>
					...
					<input
						...
						min={0}
						max={1000}
						value={Math.round(textStyle.verticalScale || 100)}
						onChange={(e) => changeProp('verticalScale', Number(e.target.value) || 100)}
						className='topcoat-text-input--large'
					/>
					<span className='style-edit-props-unit'>%</span>
				</div>
				<div className='style-edit-props-col'>
					...
					<input
						...
						min={0}
						max={1000}
						value={Math.round(textStyle.horizontalScale || 100)}
						onChange={(e) => changeProp('horizontalScale', Number(e.target.value) || 100)}
						className='topcoat-text-input--large'
					/>
					<span className='style-edit-props-unit'>%</span>
				</div>
			...
			<div className='style-edit-props-row'>
				<div className='style-edit-props-col'>
					...
					<input
						type='number'
						value={textStyle.baselineShift || 0}
						onChange={(e) => changeProp('baselineShift', Number(e.target.value) || 0)}
						className='topcoat-text-input--large'
					/>
					<span className='style-edit-props-unit'>{unit}</span>
				</div>
				<div className='style-edit-props-col'>
					...
					<div className='style-edit-color m-right'>
						...
						<div
							...
							onClick={() => setColorPickerOpen(true)}
						>
							<div style={{ background: rgbToHex(textStyle.color) }} />
			...
			{context.state.middleEast && (
				<div className='style-edit-props-row'>
					<div className='style-edit-props-col'>
						...
						<input
							type='number'
							value={textStyle.diacXOffset || 0}
							onChange={(e) => changeProp('diacXOffset', Number(e.target.value) || 0)}
							className='topcoat-text-input--large'
						/>
						<span className='style-edit-props-unit'>{unit}</span>
					</div>
					<div className='style-edit-props-col'>
						...
						<input
							type='number'
							value={textStyle.markYDistFromBaseline || 100}
							onChange={(e) => changeProp('markYDistFromBaseline', Number(e.target.value) || 0)}
							className='topcoat-text-input--large'
						/>
						<span className='style-edit-props-unit'>{unit}</span>
					</div>
			...
			<div className='style-edit-props-row'>
				<div className='style-edit-props-col'>
					...
					<select
						value={props.textProps.layerText.antiAlias || 'antiAliasNone'}
						onChange={(e) => changeAntiAlias(e.target.value)}
						className='topcoat-textarea'
					>
						...
						{['antiAliasPlatformLCD', 'antiAliasPlatformGray'].includes(
							props.textProps.layerText.antiAlias
						) && (
				...
				<div className='style-edit-props-col m-justify'>
					{textStyle.syntheticBold ? (
						<button
							...
							title={locale.editStyleBold}
							onClick={(e) => changeProp('syntheticBold', false, e)}
						>
							<BsTypeBold size={18} />
						</button>
					) : (
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleBold}
							onClick={(e) => changeProp('syntheticBold', true, e)}
						>
							<BsTypeBold size={18} />
						</button>
					)}
					{textStyle.syntheticItalic ? (
						<button
							className='topcoat-icon-button--large'
							title={locale.editStyleItalic}
							onClick={(e) => changeProp('syntheticItalic', false, e)}
						>
						...
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleItalic}
							onClick={(e) => changeProp('syntheticItalic', true, e)}
						>
							<BsTypeItalic size={18} />
						</button>
					)}
					{textStyle.fontCaps === 'allCaps' ? (
						<button
							className='topcoat-icon-button--large'
							title={locale.editStyleCapital}
							onClick={(e) => changeProp('fontCaps', null, e)}
						>
							<BsFonts size={18} />
						</button>
					) : (
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleCapital}
							onClick={(e) => changeProp('fontCaps', 'allCaps', e)}
						>
							<BsFonts size={18} />
						</button>
					)}
					{textStyle.fontCaps === 'smallCaps' ? (
						...
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleSmall}
							onClick={(e) => changeProp('fontCaps', 'smallCaps', e)}
						>
							<AiOutlineFontSize size={18} />
						</button>
					)}
			...
			<div className='style-edit-props-row'>
				<div className='style-edit-props-col m-justify'>
					{paragStyle.alignment === 'left' ? (
						<button
							className='topcoat-icon-button--large'
							title={locale.editStyleAlignLeft}
							onClick={(e) => changeParagraph('alignment', null, e)}
						>
						...
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleAlignLeft}
							onClick={(e) => changeParagraph('alignment', 'left', e)}
						>
							<AiOutlineAlignLeft size={18} />
						</button>
					)}
					{paragStyle.alignment === 'center' ? (
						<button
							className='topcoat-icon-button--large'
							title={locale.editStyleAlignCenter}
							onClick={(e) => changeParagraph('alignment', null, e)}
						>
						...
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleAlignCenter}
							onClick={(e) => changeParagraph('alignment', 'center', e)}
						>
							<AiOutlineAlignCenter size={18} />
						</button>
					)}
					{paragStyle.alignment === 'right' ? (
						<button
							className='topcoat-icon-button--large'
							title={locale.editStyleAlignRight}
							onClick={(e) => changeParagraph('alignment', null, e)}
						>
						...
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleAlignRight}
							onClick={(e) => changeParagraph('alignment', 'right', e)}
						>
							<AiOutlineAlignRight size={18} />
						</button>
					)}
					{paragStyle.hyphenate ? (
						<button
							className='topcoat-icon-button--large'
							title={locale.editStyleHyphen}
							onClick={(e) => changeParagraph('hyphenate', false, e)}
						>
							<FiMinus size={18} />
						</button>
					) : (
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleHyphen}
							onClick={(e) => changeParagraph('hyphenate', true, e)}
						>
							<FiMinus size={18} />
						</button>
					)}
					{paragStyle.hangingRoman ? (
						<button
							className='topcoat-icon-button--large'
							title={locale.editStyleHanging}
							onClick={(e) => changeParagraph('hangingRoman', false, e)}
						>
						...
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleHanging}
							onClick={(e) => changeParagraph('hangingRoman', true, e)}
						>
							<GrBlockQuote size={18} />
						</button>
					)}
				...
				<div className='style-edit-props-col m-justify'>
					{textStyle.baseline === 'superScript' ? (
						<button
							className='topcoat-icon-button--large'
							title={locale.editStyleSuper}
							onClick={(e) => changeProp('baseline', 'normal', e)}
						>
						...
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleSuper}
							onClick={(e) => changeProp('baseline', 'superScript', e)}
						>
							<GrSuperscript size={18} />
						</button>
					)}
					{textStyle.baseline === 'subScript' ? (
						...
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleSub}
							onClick={(e) => changeProp('baseline', 'subScript', e)}
						>
							<GrSubscript size={18} />
						</button>
					)}
					{textStyle.underline === 'underlineOnLeftInVertical' ? (
						<button
							className='topcoat-icon-button--large'
							title={locale.editStyleUnderline}
							onClick={(e) => changeProp('underline', 'underlineOff', e)}
						>
						...
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleUnderline}
							onClick={(e) => changeProp('underline', 'underlineOnLeftInVertical', e)}
						>
							<BsTypeUnderline size={18} />
						</button>
					)}
					{textStyle.strikethrough === 'xHeightStrikethroughOn' ? (
						<button
							className='topcoat-icon-button--large'
							title={locale.editStyleStrike}
							onClick={(e) => changeProp('strikethrough', 'strikethroughOff', e)}
						>
						...
						<button
							className='topcoat-icon-button--large--quiet'
							title={locale.editStyleStrike}
							onClick={(e) => changeProp('strikethrough', 'xHeightStrikethroughOn', e)}
						>
							<BsTypeStrikethrough size={18} />
						</button>
					)}
